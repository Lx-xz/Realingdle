...
`,t=a=>({id:a.id,name:a.name,description:a.description,image_url:a.image_url,age:a.age,created_at:a.created_at,updated_at:a.updated_at,state:Array.isArray(a.state)?a.state[0]:a.state,classes:a.classes?.map(a=>a.class)??[],races:a.races?.map(a=>a.race)??[],occupations:a.occupations?.map(a=>a.occupation)??[],associations:a.associations?.map(a=>a.association)??[],places:a.places?.map(a=>a.place)??[]}),c=async(a={})=>{let{data:c,error:i}=await e.supabase.from("characters").select(s).order("name",{ascending:a.ascending??!0});if(i)throw i;return c.map(t)};a.s(["fetchCharacters",0,c])},88699,a=>{"use strict";let e=(0,a.i(75254).default)("pencil",[["path",{d:"M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z",key:"1a8usu"}],["path",{d:"m15 5 4 4",key:"1mk7zo"}]]);a.s(["Pencil",()=>e],88699)}]);